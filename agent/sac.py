...
class SACAgent(RLAgent):
    ...
    def train(self):
        ...
        # if q0_loss_tensor.clone().detach().numpy()<500 and q0_loss_tensor.clone().detach().numpy()<500:
        ...
        # if q0_loss_tensor.clone().detach().numpy()<2000 and v_loss_tensor.clone().detach().numpy()<2000 and \
        #         q1_loss_tensor.clone().detach().numpy()<2000:
        self.update_net(self.v_target_net, self.v_evaluate_net)
        self.add_act_to_buffer = True
